...
(function($, document, window, navigator) {
    ...
    var methods = {
        init: function(options) {
            ...
            var singleHTML =
                '<span class="irs-slider main_color_background--hover single"></span>';

            var doubleHTML =
                '<span class="irs-diapason main_color_background"></span>' +
                '<span class="irs-slider main_color_background--hover from"></span>' +
                '<span class="irs-slider main_color_background--hover to"></span>';
